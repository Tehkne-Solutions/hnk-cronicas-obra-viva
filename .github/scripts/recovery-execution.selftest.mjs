...
const required = [
  ...
  [files.authorizationWorkflow, "ref: ${{ github.sha }}"],
  ...
  [files.executorWorkflow, "github.ref == 'refs/heads/main'"],
  [files.executorWorkflow, "github.event.workflow_run.id"],
  [files.executorWorkflow, "github.event.workflow_run.head_sha"],
  [files.executorWorkflow, "Require deterministic recovery executor snapshot"],
  [files.executorWorkflow, "Main advanced after recovery authorization"],
  [files.executorWorkflow, "ref: ${{ github.event.workflow_run.head_sha || github.sha }}"],
